    ...
    projectList: [
      {
        ...
        serviceDescription: `🍪 캘린더로 한 달의 쿠키 모아보기
      ...
      },
      {
        ...
        serviceIntroduction:
          'Pochak은 사용자가 직접 사진을 올리는것이 아니라, 친구들이 사용자를 중심으로 촬영한 사진을 통해 자연스럽게 일상을 기록하고 공유하는 특별한 소셜 미디어 플랫폼입니다. 다양한 시각에서의 일상을 통해 사용자들에게 새로운 경험을 제공합니다.',
  ...
  },
  {
    ...
    projectList: [
      ...
      },
      {
        ...
        serviceIntroduction:
          '모기의 예방법과 퇴치 방법을 검색한 사람들을 위해 ! 살충제, 모기향 등 모기 퇴치 물품을 구매하는 사람들을 위해 ! 다가오는 여름철, 모기로 인한 스트레스를 해소시켜주기 위한 보건 복지 분야 서비스입니다.',
        serviceDescription: `더 이상 번거로운 수백 개의 개발 기술 웹사이트를 돌아다니지 않아도 됩니다. 주요 IT 플랫폼 기업들인 토스, 네이버, 카카오, 그리고 우아한 형제들의 기술 영상과 세미나를 편리하게 한 곳에서 확인하세요.<br /><br />
        - 우수한 기술과 지식을 나누며 탁월함을 추구하는 기술 영상<br />
        - 훌륭한 개발자들의 기술 노하우와 경험이 녹아든 개발 이야기<br />
        - 온라인 및 오프라인에서 진행된 다양한 기술 공유 세미나 영상<br />
        - 개발자들의 다양한 기술 이야기와 개발 경험을 직접 들을 수 있는 행사 소개<br />
        <br /><br />
      ...
      },
      {
        ...
        serviceIntroduction:
          '"Frame"은 다양한 주제와 스타일의 사진을 업로드하고 공유할 수 있는 공간으로 다양한 사용자의 사진들을 만나볼 수 있습니다.<br />*업로드되는 사진은 모든 사용자에게 공개되며 저작권에 대한 사전 동의가 이루어집니다.',
        serviceDescription: `"Frame"은 다양한 주제와 스타일의 사진을 업로드하고 공유할 수 있는 공간으로 다양한 사용자의 사진들을 만나볼 수 있습니다.
